...
from telethon import events
import asyncio
from userbot import CMD_HELP, ALIVE_NAME, PM_MESSAGE, IONIX_NAME, IONIX_MSG, ORI_MSG
IONIX_NNAME = str(IONIX_NAME) if IONIX_NAME else str(IONIX_MSG)
 ionix = bot
...
ABUSE_STRINGS = [
	   ...
	   "`I Know Uh ez Rendi Bhai Dont show Your Randi Pesa Here`",
      "`Jag Suna suna laage tu #maderchod hai`",
     "`you talking behind meh uwu uh iz my fan now `",
    "`Wanna pass in Life Goto BRAZZER.CAM `",
    "`chullu bhar pani me doob maro`",
    "`Sellers Nasa calling Uh 😆`",
    "`Badwoo ki yojna behan bna ke ch*da uh iz badwa its your yojna?`",
    "`CHAND PE CHADA HAI CHANDYAAN KA GHODA TERA NAAM HAI MANSUR TU HAI BEHAN KA LOD*😂`",
    "`Jab se dil lga baithe tanhai me maa chu*da baithe wo kho gyi kisi aur ke pyar me hum apne hi jaato me aag lga baithe`",
...
@ionix05(pattern="^.slap(?: |$)(.*)", outgoing=True)
async def who(event):
...
@ionix.on(rekcah05(pattern=f"slap(?: |$)(.*)", allow_sudo=True))
async def who(event):
    """ slaps a user, or get slapped if not a reply. """
    replied_user = await get_user_from_event(event)
    if replied_user:
...
@ionix05(outgoing=True, pattern="^-_-$")
async def lol(lel):
    """ Ok... """
    okay = "-_-"
    for i in range(10):
...
@ionix05(outgoing=True, pattern="^.(yes|no|maybe|decide)$")
...
@onix05(outgoing=True, pattern="^;_;$")
async def fun(e):
    t = ";_;"
    for j in range(10):
        t = t[:-1] + "_;"
...
@ionix05(outgoing=True, pattern="^.fp$")
async def facepalm(e):
    """ Facepalm  🤦‍♂ """
    await e.edit("🤦‍♂")


@ionix05(outgoing=True, pattern="^.cry$")
async def cry(e):
    """ y u du dis, i cry everytime !! """
    await e.edit(choice(CRI))


@ionix05(outgoing=True, pattern="^.abuse$")
async def insult(e):
    """ I make you cry !! """
    await e.edit(choice(INSULT_STRINGS))


@ionix.on(rekcah05(pattern=f"abuse$", allow_sudo=True))
async def insult(e):
    """ Imma make you cry !! """
    await e.reply(choice(INSULT_STRINGS))


@ionix05(outgoing=True, pattern="^.cp(?: |$)(.*)")
...
@ionix05(outgoing=True, pattern="^.vapor(?: |$)(.*)")
async def vapor(vpr):
    """ Vaporize everything! """
    reply_text = list()
...
@ionix05(outgoing=True, pattern="^.str(?: |$)(.*)")
...
@ionix05(outgoing=True, pattern="^.style(?: |$)(.*)")
async def zal(zgfy):
...
@ionix.on(rekcah05(pattern=f"style(?: |$)(.*)", allow_sudo=True))
async def zal(zgfy):
    """ Invoke the feeling of chaos. """
    if not zgfy.text[0].isalpha() and zgfy.text[0] not in ("/", "#", "@", "!"):
        reply_text = list()
...
@ionix05(outgoing=True, pattern="^.hi$")
async def hoi(hello):
    """ Greet everyone! """
    await hello.edit(choice(HELLOSTR))


@ionix05(outgoing=True, pattern="^.owo(?: |$)(.*)")
async def faces(owo):
    """ UwU """
...
@ionix05(outgoing=True, pattern="^.react$")
async def react_meme(react):
    """ Make your userbot react to everything. """
    await react.edit(choice(FACEREACTS))


@ionix05(outgoing=True, pattern="^.iwi(?: |$)(.*)")
...
@ionix05(outgoing=True, pattern="^.shg$")
...
@ionix05(outgoing=True, pattern="^.Uff$")
async def Oof(e):
    t = "uff"
    for j in range(15):
        t = t[:-1] + "uf"
...
@ionix05(outgoing=True, pattern="^.moon$")
...
@ionix05(outgoing=True, pattern="^.earth$")
asy  nc def earth(event):
 deq = deque(list("🌏🌍🌎🌎🌍🌏🌍🌎"))
    try:
        for x in range(32):
            await sleep(0.1)
...
@ionix05(outgoing=True, pattern="^.clock$")
...
@ionix05(outgoing=True, pattern="^.rain$")
...
@ionix05(outgoing=True, pattern="^.love$")
...
@ionix05(outgoing=True, pattern="^.mock(?: |$)(.*)")
...
@ionix05(outgoing=True, pattern="^.clap(?: |$)(.*)")
...
@ionix05(outgoing=True, pattern="^.bt$")
async def bluetext(bt_e):
    """ Believe me, you will find this useful. """
    if await bt_e.get_reply_message() and bt_e.is_group:
        await bt_e.edit(
            "/BLUETEXT /MUST /CLICK.\n"
            "/ARE /YOU /A /STUPID /ANIMAL /WHO /IS /ATTRACTED /TO /COLOURS?")


@ionix05(outgoing=True, pattern=r"^.if (.*)")
...
@ionix05(pattern=r".type(?: |$)(.*)", outgoing=True)
...
@ionix05(outgoing=True, pattern="^.fail$")
async def fail(e):
...
@ionix05(outgoing=True, pattern="^.lol$")
async def lol(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("`\n ░░░░░░░░╔══════╗░░░░░░/ ' "
                              " 'n\ ░░░░░░░░║▒╔══╗▒║░░░░░░/' "
...
@ionix05(outgoing=True, pattern="^.lool$")
async def lool(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("`\n╭╭━━━╮╮┈┈┈┈┈┈┈┈┈┈\n┈┃╭━━╯┈┈┈┈▕╲▂▂╱▏┈\n┈┃┃╱▔▔▔▔▔▔▔▏╱▋▋╮┈`"
                     "`\n┈┃╰▏┃╱╭╮┃╱╱▏╱╱▆┃┈\n┈╰━▏┗━╰╯┗━╱╱╱╰┻┫┈\n┈┈┈▏┏┳━━━━▏┏┳━━╯┈`"
...
@ionix05(outgoing=True, pattern="^.nih$")
async def nih(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("`\n(\_/)`"
                     "`\n(•_•)`"
...
@ionix05(outgoing=True, pattern="^.hello$")  
async def gtfo(e):
   if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("`\n█████████`" 
                     "`\n█▄█████▄█`"    
...
@ionix05(outgoing=True, pattern="^.ml(?: |$)(.*)")
async def gtfo(e):
...
@ionix05(outgoing=True, pattern="^.taco$")  
async def taco(e):
   if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("\n{\__/}"
                     "\n(●_●)"
...
@ionix05(outgoing=True, pattern="^.paw$")  
async def paw(e):
   if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("`(=ↀωↀ=)")


@ionix05(outgoing=True, pattern="^.tf$")  
async def tf(e):
   if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("(̿▀̿ ̿Ĺ̯̿̿▀̿ ̿)̄  ")  
       
                  
@ionix05(outgoing=True, pattern="^.gey$")            
async def gey(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("`\n┈┈┈╭━━━━━╮┈┈┈┈┈\n┈┈┈┃┊┊┊┊┊┃┈┈┈┈┈`"
                     "`\n┈┈┈┃┊┊╭━╮┻╮┈┈┈┈\n┈┈┈╱╲┊┃▋┃▋┃┈┈┈┈\n┈┈╭┻┊┊╰━┻━╮┈┈┈┈`"
...
@ionix05(outgoing=True, pattern="^.gay$")            
async def gey(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("`\n┈┈┈╭━━━━━╮┈┈┈┈┈\n┈┈┈┃┊┊┊┊┊┃┈┈┈┈┈`"
                     "`\n┈┈┈┃┊┊╭━╮┻╮┈┈┈┈\n┈┈┈╱╲┊┃▋┃▋┃┈┈┈┈\n┈┈╭┻┊┊╰━┻━╮┈┈┈┈`"
...
@ionix05(outgoing=True, pattern="^.bot$")
async def bot(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("` \n   ╲╲╭━━━━╮ \n╭╮┃▆┈┈▆┃╭╮ \n┃╰┫▽▽▽┣╯┃ \n╰━┫△△△┣━╯`"
                     "`\n╲╲┃┈┈┈┈┃  \n╲╲┃┈┏┓┈┃ `")
...
@ionix05(outgoing=True, pattern="^.hey$")
async def hey(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("\n┈┈┈╱▔▔▔▔╲┈╭━━━━━\n┈┈▕▂▂▂▂▂▂▏┃HEY!┊😀`"
                     "`\n┈┈▕▔▇▔▔┳▔▏╰┳╮HEY!┊\n┈┈▕╭━╰╯━╮▏━╯╰━━━\n╱▔▔▏▅▅▅▅▕▔▔╲┈┈┈┈`"
...
@ionix05(outgoing=True, pattern="^.nou$")
async def nou(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("`\n┈╭╮╭╮\n┈┃┃┃┃\n╭┻┗┻┗╮`"
                     "`\n┃┈▋┈▋┃\n┃┈╭▋━╮━╮\n┃┈┈╭╰╯╰╯╮`"
...
@ionix05(outgoing=True, pattern="^.mf$")  
async def gtfo(e):
   if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit(
"\n......................................../´¯/) "
...
@ionix05(outgoing=True, pattern="^?sayhi$")
async def shalom(e):
    await e.edit(
        "\n💛💛💛💛💛💛💛💛💛"
        "\n💛🔷🔷🔷🔷🔷🔷🔷💛"
...
@ionix05(outgoing=True, pattern="^?call(?: |$)(.*)")
...
async def _(event):
   ...
   # if input_str == "call":
    ...
    animation_chars = [
            ...
            "`Me: Yo this is` @ionix05 ,`Please Connect me to my lil bro,lel`",
            "`User Authorised.`",
            "`Calling lel Durov`  `At +94776996xxx`",
            "`Private  Call Connected...`",
            "`Me: Hello Sir, Please Ban This Telegram Account.`",    
            "`lel: May I Know Who Is This?`",
            f"`Me: Yo Brah, I Am` {IONIX_NNAME} ",
...
async def _(event):
    ...
    if x==32:
        ...
        await event.edit("`\"You know you?re getting old when your parents start disappointing you, instead of you disappointing thesystem has made it so we get no experience.\"`")
...
@ionix05(outgoing=True, disable_errors=True, pattern="^.fry2(?: |$)(.*)")
...
@ionix05(outgoing=True, pattern="^.instant(?: |$)(.*)")
async def _(event):
    if event.fwd_from:
        return 
    if not event.reply_to_msg_id:
...
@ionix05(outgoing=True, pattern="^.play$")
...
@ionix05(outgoing=True, pattern="^.ding$")
...
@ionix05(outgoing=True, pattern="^.leave$")
async def leave(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("`You must Leaving dis Group kek!`")


@ionix05(outgoing=True, disable_errors=True, pattern="^.wtf$")
async def _(event):
...
@ionix05(outgoing=True, disable_errors=True, pattern="^.whack$")
async def _(event):
   ...
   # if input_str == "chu":
    ...
    animation_chars = [
            ...
            "Targeted Account Hacked...! AB MAZE KARO LODU\n\n ✅ File has been successfully uploaded to my server.\nWhatsApp Database:\n`./DOWNLOADS/msgstore.db.crypt12`"
        ]
...
@ionix05(outgoing=True, disable_errors=True, pattern="^.snake$")
async def _(event):
...
@ionix05(outgoing=True, disable_errors=True, pattern="^.soler$")
async def _(event):
...
@ionix05(outgoing=True, disable_errors=True, pattern="^.think$")
async def _(event):
   ...
   # if input_str == "chu":
    ...
    animation_chars = [
            ...
            "T+I#K@₹G",
            "THINKING..."
            "NAHI SOCHUNGA JAA JAAKE MAR JA 🤔"
        ]
...
@ionix05(outgoing=True, disable_errors=True, pattern="^.hack$")
async def _(event):
   ...
   # if input_str == "chu":
    ...
    animation_chars = [
            ...
            "`Hacking... 84%\n█████████████████████▒▒▒▒ `",
            "`Hacking... 100%\n█████████HACKED███████████ `",
            "`Targeted Account Hacked...USER'S DIL MUH ME AA GYA SUCESSFULLY(some data tranferred sucessfully via this) `"
        ]
...
@ionix05(outgoing=True, disable_errors=True, pattern="^.bomb(?: |$)(.*)")
async def _(event):
    if event.fwd_from:
        return
...
@ionix05(outgoing=True, disable_errors=True, pattern="^.sad(?: |$)(.*)")
...
@ionix05(outgoing=True, disable_errors=True, pattern="^.play1$")
async def _(event):
...
@ionix05(outgoing=True, disable_errors=True, pattern="^.play2$")
async def _(event):
...
@ionix05(outgoing=True, disable_errors=True, pattern="^.play3$")
async def _(event):
...
@ionix05(outgoing=True, pattern="^.moon2$")
async def test(event):
    if event.fwd_from:
        return 
    await event.edit("🌕🌕🌕🌕🌕🌕🌕🌕\n🌕🌕🌖🌔🌖🌔🌕🌕\n🌕🌕🌗🌔🌖🌓🌕🌕\n🌕🌕🌗🌔🌖🌓🌕🌕\n🌕🌕🌖🌓🌗🌔🌕🌕\n🌕🌕🌗🌑🌑🌓🌕🌕\n🌕??🌗👀🌑🌓🌕🌕\n🌕??🌘👄🌑🌓🌕🌕\n🌕🌕🌗????🌒🌕🌕\n🌕🌖🌑🌑🌑🌑🌔🌕\n🌕🌘🌑🌑🌑🌑🌒🌕\n🌖🌑🌑🌑🌑🌑🌑🌔\n🌕🤜🏻🌑🌑🌑🌑🤛🏻🌕\n🌕🌖🌑🌑🌑🌑🌔🌕\n🌘🌑🌑🌑🌑🌑🌑🌒\n🌕🌕🌕🌕🌕🌕🌕🌕")

@ionix05(outgoing=True, pattern=".city$")
async def test(event):
    if event.fwd_from:
        return 
    await event.edit("""☁☁🌞  ek  ☁  mai       ☁
    Aur ☁  ✈    ek    ☁ tu 🚁 dono  ☁ mile  ☁ iss  ☁ tarah         ☁     ☁   ☁
...
@ionix05(outgoing=True, pattern="^.cheer$")
async def cheer(event):
    if event.fwd_from:
        return
    await event.edit("💐💐😉😊💐💐\n☕ Cheer Up  🍵\n🍂 ✨ )) ✨  🍂\n🍂┃ (( * ┣┓ 🍂\n🍂┃*💗 ┣┛ 🍂 \n🍂┗━━┛  🍂🎂 For YOU  🍰\n💐💐😌😚💐💐")

@ionix05(outgoing=True, pattern="^.getwell$")
async def getwell(event):
    if event.fwd_from:
        return
    await event.edit("🌹🌹🌹🌹🌹🌹🌹🌹 \n🌹😷😢😓😷😢💨🌹\n🌹💝💉🍵💊💐💝🌹\n🌹 GetBetter Soon! 🌹\n🌹🌹🌹🌹🌹🌹🌹🌹")

@ionix05(outgoing=True, pattern="^.luck$")
async def luck(event):
    if event.fwd_from:
        return
    await event.edit("💚~🍀🍀🍀🍀🍀\n🍀╔╗╔╗╔╗╦╗✨🍀\n🍀║╦║║║║║║👍🍀\n🍀╚╝╚╝╚╝╩╝。 🍀\n🍀・・ⓁⓊⒸⓀ🍀\n🍀🍀🍀 to you💚")

@ionix05(outgoing=True, pattern="^.love2$")
...
@ionix05(outgoing=True, disable_errors=True, pattern="^.nakal$")
...
@ionix05(outgoing=True, pattern="^.police$")
...
async def _(event):
    ...
    animation_chars = [
            ...
            "🔵🔵🔵⬜⬜⬜🔴🔴🔴\n🔵🔵🔵⬜⬜⬜🔴🔴🔴\n🔵🔵🔵⬜⬜⬜🔴🔴🔴",
            "🔴🔴🔴⬜⬜⬜🔵🔵🔵\n🔴🔴🔴⬜⬜⬜🔵🔵🔵\n🔴🔴🔴⬜⬜⬜🔵🔵🔵",
            " **Police ion dev bhagwan ziddi blossy carbon marvellous nibba ravan arthur iz Here**"
...
@ionix05(outgoing=True, pattern=r"^\.(?:penis|dick)\s?(.)?")
...
@ionix05(outgoing=True, pattern="^.noob$")
async def insult(e):
    """ Imma make you cry !! """
...
@ionix05(outgoing=True, pattern="^.abuse3$")
...
@ionix05(outgoing=True, pattern="^.fuck$")
...
@ionix05(outgoing=True, pattern="^.xxx$")
...
@ionix05(outgoing=True, pattern="^.sux$")
...
@ionix05(outgoing=True, pattern="^.dump ?(.*)")
async def _(message):
    try:
